...
Pod::Spec.new do |s|
  ...
  s.homepage     = "https://github.com/slCreation/SLBarCharts"
  # s.screenshots  = "www.example.com/screenshots_1.gif", "www.example.com/screenshots_2.gif"

  s.license      = { :type => "MIT", :file => "FILE_LICENSE" }
  s.author             = { "LeiShao" => "276482207@qq.com" }
  # Or just: s.author    = "LeiShao"
  # s.authors            = { "LeiShao" => "276482207@qq.com" }
  # s.social_media_url   = "http://twitter.com/LeiShao"
